...
namespace MissionPlanner.Mavlink
{
	public static class MavlinkUtil
	{
		...
		// ### Eric is taking this out.  Hopefully we don't need to read using pointers to parse the tlog file.
	    unsafe public static T ReadUsingPointer<T>(byte[] data, int startoffset) where T : struct
	    {
