...
namespace MissionPlanner.Mavlink
{
    public class MAVLinkInterface : MAVLink, IDisposable
    {
		...
		// New definitions Eric is adding - redundant now.  MUst have imported that definiitoon after I added this
...
//		};
        ...
        /// </summary>
		/// 
		// ### Eric removed the progress report stuff, don't want these dependencies.
//        ProgressReporterDialogue frmProgressReporter;
		...
		// ### Eric is removing the logging of bytes received and sent
...
//
		...
		// ### Eric is removing the progress reporting
...
//        }
		...
		// ### Eric is removing the progress reporting.  Can't remove this whole method, but can remove the parameter.
...
//                    "Getting Params.. (sysid " + MAV.sysid + " compid " + MAV.compid + ") ");
                ...
                byte[] temp = ASCIIEncoding.ASCII.GetBytes("Mission Planner " + "ERICTMP" + "\0");
...
//                System.Windows.Forms.MessageBox.Show("Failed to change Modes");
				Console.Write ("Failed to change modes");
            }
        }
...
//					Console.Write("No mode changed " + modein);
//					return false;
//                }
            }
            catch
...
//                System.Windows.Forms.MessageBox.Show("Failed to find Mode");
				Console.Write ("failed to find mode");
				return false;
            }
		...
		// Eric is ignoring setting the autopilot type, should'nt care as much about this in tlog files
