...
namespace MissionPlanner
{
    public class MAVState : MAVLink
    {
        ...
        /// </summary>
		/// 
		/// ### Eric removed this method, could hurt me.  But currentState is in MissionPlanner/CurrentState.cs, which has a bunch of big dependencies
//        public CurrentState cs = new CurrentState();
		...
		// ### Eric removed this code.  Do I ever need the product ID when parsing TLog files?
