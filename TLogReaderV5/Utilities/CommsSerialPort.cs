...
//        public new bool RtsEnable { get { return base.RtsEnable; } set { log.Info(base.PortName + " RtsEnable " + value); if (base.RtsEnable == value) return; if (ispx4(base.PortName)) return; base.RtsEnable = value; } }
        ...
        */
        ...
        {
				// Is the following criticla for the correct functioning of toggleDTR? Eric ###
...
//            }
		...
		// Eric is removing this.  Not sure whether it needs to assign a nice name for my purposes.
...
//            }
		...
		// Eric is removing safe file handling...
		...
		// Eric is removing this NativeMethod ###
